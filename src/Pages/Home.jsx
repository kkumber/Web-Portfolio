...
const Home = () => {
    ...
    <div className="grid grid-cols-3 grid-rows-5 gap-2 text-white">
        ...
        <div className="col-start-2 col-end-4 row-start-2 row-end-5 "><GlassEffectContainer title={'Profile'}/> </div>
        <div className="col-start-2 col-end-4 row-start-5 row-end-6 "><BlurEffectContainer title={'Full-Stack Web Engineer'} /></div>
        <div className="col-start-3 col-end-4 row-start-1 row-end-3 ">Image</div>
        <div className="col-start-3 col-end-4 row-start-3 row-end-4 "><BlurEffectContainer title={'Quote'}/> </div>
