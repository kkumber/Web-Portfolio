...
const Home = () => {
  return (
    <div className="min-h-screen text-zinc-300 font-sans selection:bg-white/10 selection:text-white antialiased pb-24">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-12 md:py-24 relative z-10 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[minmax(180px,auto)]">
          ...
          {/* ABOUT ME TILE */}
          <div 
            className="md:col-span-12 lg:col-span-3 lg:row-span-2 glass-card rounded-[2.5rem] p-8 flex flex-col relative overflow-hidden group border-white/10 animate-block-drop"
          ...
          {/* RECOGNITION TILE */}
          <div 
            className="md:col-span-12 lg:col-span-4 glass-card rounded-[2.5rem] p-8 flex flex-col justify-center group relative overflow-hidden border-white/10 animate-block-drop"
