...
const Home = () => {
    ...
    <div className="grid my-20 md:grid-cols-3 md:grid-rows-5 gap-2 text-white">
        ...
        <div className="md:col-start-3 md:col-end-4 md:row-start-1 md:row-end-3 animate-fadeLeft md:order-6"><img src="/images/banner.jpg" alt="Picture" className="h-full object-cover" /></div>
